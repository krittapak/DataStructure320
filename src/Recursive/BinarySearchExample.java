...
public class BinarySearchExample {
    ...
    public static void main(String[] args) {
        Integer[] data = {2, 7, 8, 12, 14, 25, 26, 39, 47, 53, 55};
...
//        System.out.println("key 39,position=" + pos);
        int pos = binarySearch(data, 25,0,data.length-1);
        System.out.println("key 25,position=" + pos);
        pos = binarySearch(data, 39,0,data.length-1);
        System.out.println("key 39,position=" + pos);
    }
...
//    }
    ...
    private static int binarySearch(Object[] data,Object key,int right,int left){
        if (left>right) {
            return -1;
        }
